---
title: <span style="color:#646420"> **Recursos  3.2**</span>  
author: "dgonzalez "
subtitle: <span style="color:#646420">**Módulo 3- Unidad 3.2**</span> 
output:
  html_document:
    toc: yes
    toc_depth: 2
...
knitr::include_graphics("img/confianza.png")
```
...
url <- "https://www.youtube.com/embed/5WkEIGMPh0Q"
...
knitr::include_graphics("img/resumen302.png")
```
...
<!-- tags$iframe( -->
<!--   src = "pdf/STaller_Intervalos_de_confianza.pdf", -->
<!--   width = "100%", -->
<!--   height = "844" -->
<!-- ) -->
<!-- ``` -->
...
<!-- Nota : -->
<!-- Como se calculan los parametros  -->

<!-- 1. Calcula la proporción del ancho y alto del PDF en formato carta (relacion entre ancho/alto), que es de 8.5 pulgadas de ancho y 11 pulgadas de alto. La proporción es de 11/8.5 = 1.2941. -->

<!-- 2. Calcula la altura en píxeles necesaria para mostrar todo el PDF en formato carta en la ventana. Para ello, multiplica el ancho del PDF en pulgadas por la proporción del paso 1 y luego multiplica por 96 píxeles por pulgada, que es la resolución predeterminada de la pantalla. La fórmula es: alto en píxeles = ancho en pulgadas * proporción * 96. -->

<!-- 3. Utiliza el valor calculado en el paso anterior como valor del parámetro height en la función tags$iframe(). -->

<!-- Por ejemplo, si tu PDF tiene un ancho de 7 pulgadas, puedes calcular la altura necesaria para mostrarlo completo en formato carta de la siguiente manera: -->

<!-- alto en píxeles = 7 * 1.2941 * 96 = 844 -->
