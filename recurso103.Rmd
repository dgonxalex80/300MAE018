---
title: <span style="color:#235784"> **Indicadores estadísticos**</span>  
author: "dgonzalez "
...
knitr::include_graphics("img/tablero1.jpg")
```
...
```{r, warning=FALSE, message=FALSE, fig.height=2.5, fig.width=10} 
 p=ggplot(futbol, aes(x=off))+geom_boxplot(fill = "#40A8C4",           # Color caja
                alpha = 0.3,        # Transparencia
                color = "#000000",          # Color del borde
                outlier.colour = "#000000") # Color atípicos
 
 p + geom_text(data = NULL, x = 1.63, y = 0.34, label = "Q3",col="#b0394a")+
     geom_text(data = NULL, x = 1.2, y = 0.34, label = "Q2",col="#b0394a")+
     geom_text(data = NULL, x = 0.6, y = 0.34, label = "Q1",col="#b0394a") +
     geom_text(data = NULL, x = 0.2, y = 0.34, label = "mín",col="#b0394a") +
     geom_text(data = NULL, x = 3.5, y = 0.34, label = "máx",col="#b0394a") +
     geom_text(data = NULL, x = 3, y = 0.34, label = "atípicos",col="#b0394a") +
     geom_text(data = NULL, x = 1.166468, y = 0, label = "*  media",col="#b0394a")# +
     geom_text(data = NULL, x = 1.2, y = 0.34, label = "media",col="#b0394a")
...
boxplot(futbol$off, las=1, horizontal = TRUE, col = "#40A8C4")

# library(ggplot2)
# ggplot(futbol, aes(x = off)) +
#   geom_boxplot(fill = "#40A8C4", orientation = "horizontal") +
#   labs(title = "Boxplot de Offense", x = "Valor de Offense") +
#   theme_minimal()
```
...
<center>
<iframe width="800" height="450" src="https://www.youtube.com/embed/dWVs-M7oCh4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
knitr::include_graphics("img/person-1245959_1920.jpg")
```
