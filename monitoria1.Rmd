...
|3. |Dscribe la dispersión de los datos en torno a la media en términos relativos.
...
|6. | El polígono de frecuencias, es especialmente apto para comparar diferentes disribuciones.|
