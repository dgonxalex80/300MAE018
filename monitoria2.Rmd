---
title: <span style="color:#235784"> **Monitoria 2**</span>  
author: "dgonzalez "
subtitle: <span style="color:#235784">**Módulo 2- Unidad 2.2**</span> 
output:
   html_document:
      toc: no
      toc_depth: 2
...
**11.** Para una variable aleatoria con función de densidad : $f(x)= x/8$ para $3 < X < 5$. 
...
**12.** Suponga que $X$ tiene una función de distribución acumulada :
...
**13.** Para la variable aleatoria que tiene la siguiente función de distribución de probabilidad :
...
**14.** Para una variable con función de distribución de probabilidad : 
...
**15.** Para una variable aleatoria con función de distribución de probabilidad: $f(x)= (3/4)(1/4)^{x}$, para $x=0, 1, 2, 3,...$
...
**16.** Sponga que $X$ tiene una función de probabilidad acumulada: 
...
**17.** El tiempo de reparación (en minutos) de una máquina fotocopiadora tiene una función de densidad:
...
**19.** Para una variable aleatoria con función de densidad : $f(x)= x/8$ para $3 < X < 5$. 
...
**20.** Suponga que $X$ tiene una función de distribución acumulada:
...
**21.** Para la variable aleatoria que tiene la siguiente función de distribución de probabilidad :
...
**22.** Para una variable con función de distribución de probabilidad : 
...
**23.** Para una variable aleatoria con función de distribución de probabilidad: $f(x)= (3/4)(1/4)^{x}$, para $x=0, 1, 2, 3,... $
...
**24.** Una de las preocupaciones que tienen los padres hoy en dia está relacionada con el tiempo que pasan sus hijos usando celular. Un estudio determinó que el número de llamadas que un joven realiza durante un dia es una variable aleatoria ($X$) con función de distribución :
